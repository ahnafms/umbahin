...
export default function OrderDetailPage() {
  ...
  const redirectPayment = () => {
    console.log(isOwner);
    if (isOwner) {
      router.push(`/(homepage)/orderDetail/barcode/${index}`);
    } else {
      router.push(`/(homepage)/orderDetail/scan/${index}`);
    }
  };
        ...
        <YStack flex={1} p={media.md ? '$5' : '$2'} bg="#ffffff" width={media.md ? '100%' : 'auto'}>
                      ...
                      <View ai="center" w={50} h={50}>
                        <YStack ai="center" jc="center">
                          <View
                            ...
                            h={50}
                            borderColor={
                              ['DRYING', 'DELIVER'].includes(data.status)
                                ? '#34ABEE'
                                : ['COMPLETE'].includes(data.status)
                                  ? '#61e6bd'
                                  : '#B2B5C1'
          ...
          <YStack width="100%" space="$4" p="$2" pt="$7">
            ...
            <XStack space="$2" ai="flex-end" jc="center">
              <Pressable>
                <Button onPress={() => redirectPayment()} bc="#34ABEE" w="100%" h="$3">
